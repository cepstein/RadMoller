...
int main(int argc, char* argv[])
    ...
    fprintf(oFile,"Photon Theta Cut: %.3f\t Rad Lepton Theta Cut: %.3f\tElastic Lepton Theta Cut: %.3f\n",tkCut,tqrCut,xeCut);
    if(txt_flag){
    ...
    TH1D *w_int = new TH1D("w_int","Lepton Angular Dist",89,0.5,89.5);
